(function($) {
    var mainContainerHeight,
        wraperHeight = $('#agora-wrapper').height();
    ...
    $(function() {
        ...
        var appId = "71141083ee3a45e8b79222ee9d802306";
        /* Joining channel */
        window.initAgoraRTC = function initAgoraRTC() {
        ...
        function displayStream(tagId, stream, width, height, className, parentNodeId) {
            ...
            if (className.indexOf('local-partner-video') > -1) {
                var videoWidth = $('#agora-wrapper').height() * 4 / 3;
